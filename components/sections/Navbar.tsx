...
export default function Navbar() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Show navbar only after scrolling past 80% of the viewport height (Hero section)
  ...
  return (
    <motion.header 
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-colors duration-300 border-b bg-[#F9F9F9]/90 backdrop-blur-md border-black/10 py-4 shadow-sm`}
    >
